...
const ContactInvitationsModal = ({
  ...
  <Modal isOpen={isOpen} toggle={onClose} centered scrollable>
    <ModalHeader toggle={onClose}>Contact invitations</ModalHeader>
                ...
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div className="d-flex gap-1 flex-shrink-0">
                    <Button
                      ...
                      aria-label={`Accept invitation from ${invitation.sender.username}`}
                      disabled={busy}
                    ...
                    <Button
                      ...
                      aria-label={`Decline invitation from ${invitation.sender.username}`}
                      disabled={busy}
